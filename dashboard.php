...
<div class="content-wrapper ">
    ...
    <div class="row">
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card back-color1 card-img-holder text-white">
                <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Visitors <i class="mdi mdi-chart-line mdi-24px float-end"></i>
                    </h4>
        ...
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card back-color2 card-img-holder text-white">
                <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Booking <i
        ...
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card back-color3 card-img-holder text-white">
                <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
    ...
    <div class="row">
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Recent Tickets</h4><br><br><br>
