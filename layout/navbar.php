<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top bg-dark d-flex flex-row  ">
            ...
            <div class="search-field d-none d-md-block ">
                <form class="d-flex align-items-center h-100" action="#">
                    <div class="input-group text-white">
                        ...
                        <input type="text" class="form-control bg-transparent border-0 text-white" placeholder="Search projects">
                    </div>
                </form>
            </div>
